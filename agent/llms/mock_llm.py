...
def mock_llm_json_response(prompt: str) -> str:
    ...
    elif any(keyword in prompt_lower for keyword in ["search", "find", "lookup", "what is", "who is"]):
    ...
    responses = {
        ...
        "get_weather": 
            lambda r: (
                ...
                f"The humidity is {r['humidity']} and the wind speed is {r['wind_speed']}."
            )
    }
